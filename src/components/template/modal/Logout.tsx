  ...
  return (
    <div className={`${props.modal} fixed z-10 inset-0 overflow-y-auto`}>
      ...
      >
        <div
          className={
            'fixed inset-0 bg-slate-400 bg-opacity-75 transition-opacity'
          }
        />
        ...
        >
          <div
            className={
              'bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 dark:bg-slate-900'
            }
          >
            <div className={'sm:flex sm:items-start'}>
              ...
              <div className={'mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'}>
                <h3
                  className={
                    'text-lg leading-6 font-medium text-slate-900 dark:text-slate-200'
                  }
                >
                  Sair do Sistema
                </h3>
          ...
          <div
            className={
              'bg-slate-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse dark:bg-slate-800'
            }
          >
            <button
